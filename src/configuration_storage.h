...
#define CONFIGURATION_STORAGE_VERSION			102
...
extern void configuration_storage_get_acceleration_offset_vector(acceleration_vector_t *); /* acceleration_t *accel */
extern void configuration_storage_set_acceleration_offset_vector(acceleration_vector_t *); /* acceleration_t *accel */

extern void configuration_storage_get_angularvelocity_offset_vector(angularvelocity_vector_t *); /* angularvelocity_t *angularvelocity */
extern void configuration_storage_set_angularvelocity_offset_vector(angularvelocity_vector_t *); /* angularvelocity_t *angularvelocity */
