 ...
 *
 *      Übersicht gängiger VT100 Befehle
...
void vt100_clear_input_buffer(void)
{
	...
	//den eventuell noch gef√ºllten Sendebuffer des PC lesen und verwerfen
...
char vt100_get_choice(void)
{
	...
	//Wertebereichpr√ºfung und Kconvertierung zu Gro√übuchstaben
	if(isalpha(choice)) {
