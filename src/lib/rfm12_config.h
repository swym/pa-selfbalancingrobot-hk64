...
/*
	...
	RFM12           | AVR                                   | HK64 (FB4 ATM64-P II LS)
	----------------+---------------------------------------+-------------------------
	SDO             | MISO                                  | PB3  (MISO)   PORT B
	nIRQ            | INTn                                  | INT2 (PD2)    PORT D
	FSK/DATA/nFFS   | VCC                                   |
	DCLK/CFIL/FFIT  |  -                                    |
	CLK             |  - 							        |
	nRES            |  -                                    |
	...
	GND             | GND                                   |
	nINT/VDI        |  -                                    |
	SDI             | MOSI                                  | PB2  (MOSI)   PORT B
	SCK             | SCK                                   | PB1  (SCK)    PORT B
	nSEL            | Slave select pin defined below        | PD4  (IC1)    PORT D
*/
...
//SPI port
//HK64: Hardware SPI Interface on PORT B
#define DDR_SPI     DDRB
